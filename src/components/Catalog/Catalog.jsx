...
const Catalog = () => {
    const categories = [
        { id: 1, title: 'Сухофрукти', img: '/img/categories/dry_fruits.png', link: '/catalog/dried_fruits' },
        { id: 2, title: 'Солодощі', img: '/img/categories/sweets.png', link: '/catalog/candies' },
        ...
        { id: 6, title: 'Суперфуд', img: '/img/categories/superfood.png', link: '/catalog/super_food' },
