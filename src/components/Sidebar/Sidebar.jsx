    ...
    return (
        <aside className="sidebar">
            <ul className="sidebar-menu">
                ...
                <li><Link to="/catalog/dried-fruits"><img src="/img/dried_fruits.svg" alt="dried-fruits" /> <span>{t('category.dried-fruits')}</span></Link></li>
                ...
                <li><Link to="/catalog/snacks"><img src="/img/all_goods.svg" alt="snacks" /> <span>{t('category.snacks')}</span></Link></li>
