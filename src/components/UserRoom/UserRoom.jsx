        ...
        <section className="account-section container">
            ...
            <div className="user-summary-card">
                <div className="user-summary-info">
                    ...
                    <div
                        className={`room-user-avatar-circle interactive ${isUploading ? 'uploading' : ''}`}
                        onClick={() => !user.imageUrl && !isUploading && fileInputRef.current.click()}
                    >
                        {user.imageUrl ? (
                            <>
                                <img src={`${image_api}${user.imageUrl}`} alt="User Avatar" className="avatar-image" />
                                <div className="avatar-overlay delete-overlay" onClick={handleDeleteAvatar}>
                                    <svg className="overlay-icon" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" ><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
                                </div>
                            </>
                        ) : (
                            <>
                                <img className="white-user-img-room" src="/img/white_user.svg" alt="User" />
                                <div className="avatar-overlay add-overlay">
                                    <svg className="overlay-icon" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                                </div>
                            </>
                        )}
